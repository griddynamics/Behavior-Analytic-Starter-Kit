...
1. Web store not supported checkout of shopping cart, because ssl is not configured.
...
1. Config of transaction log generator supported hierarchy of category only (tree, not graph)
